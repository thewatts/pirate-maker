...
# editor graphics
EDITOR_DATA = {
  0 => {style: "player", type: "object", menu: nil, menu_surf: nil, preview: nil, graphics: "../graphics/player/idle_right"},
  1 => {style: "sky", type: "object", menu: nil, menu_surf: nil, preview: nil, graphics: nil},

  2 => {style: "terrain", type: "tile", menu: "terrain", menu_surf: "../graphics/menu/land.png", preview: "../graphics/preview/land.png", graphics: nil},
